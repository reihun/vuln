!function (r) {
  function e(e) {
    for (var t, p, c = e[0], i = e[1], a = e[2], s = 0, l = []; s < c.length; s++) p = c[s], 
    o[p] &&
    l.push(o[p][0]),
    o[p] = 0;
    for (t in i) Object.prototype.hasOwnProperty.call(i, t) &&
    (r[t] = i[t]);
