...
const U = r => r == null,
    R = r => encodeURIComponent(r).replaceAll(
        /[!'()*]/g,
...
function D(r) {
    switch (r.arrayFormat) {
        case "index":
            return e => (t, n) => {
                const f = t.length;
                return n === void 0 || r.skipNull && n === null || r.skipEmptyString && n === ""
                    ? t
                    : n === null
                        ? [
                            ...t,
        ...
        case "bracket":
            return e => (t, n) => n === void 0 || r.skipNull && n === null || r.skipEmptyString && n === ""
                ? t
                : n === null
                    ? [
                        ...t,
        ...
        case "bracket-separator":
            {
                const e = r.arrayFormat === "bracket-separator"
                    ? "[]="
                    : "=";
                return t => (n, f) => f === void 0 || r.skipNull && f === null || r.skipEmptyString && f === ""
                    ? n
                    : (
                        f = f === null
                            ? ""
...
function h(r, e, t) {
    return t === "string" && typeof r == "string"
        ...
        : typeof t == "function" && typeof r == "string"
            ? t(r)
            : e.parseBooleans && r !== null && (
                r.toLowerCase() === "true" || r.toLowerCase() === "false"
            )
                ? r.toLowerCase() === "true"
                : t === "number" && !Number.isNaN(Number(r)) && typeof r == "string" && r.trim() !== "" || e.parseNumbers && !Number.isNaN(
                    Number(r)
...
function m(r, e) {
    ...
    for (const [f, a] of Object.entries(n)) 
        ...
        typeof a == "object" && a !== null && e.types[f] === "string"
            ? n[f] = Object
                .values(a)
    ...
    return e.sort === !1
        ...
        : (
            ...
            const c = n[a];
            return f[a] = c && typeof c == "object" && !Array.isArray(c)
                ? j(c)
                : c,
            f
        }, Object.create(null))
