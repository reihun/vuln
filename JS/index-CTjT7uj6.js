...
p.prototype.setState = function (e, t) {
    if (typeof e != "object" && typeof e != "function" && e != null) 
        throw Error(
            "setState(...): takes an object of state variables to update or a function whic" +
            "h returns an object of state variables."
        );
    this
        .updater
...
o.cloneElement = function (e, t, r) {
    ...
    if (t != null) {
        ...
        for (i in t) 
            P.call(t, i) && !x.hasOwnProperty(i) && (
                n[i] = t[i] === void 0 && f !== void 0
                    ? f[i]
                    : t[i]
            )
    }
